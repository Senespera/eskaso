...
{switch(room){
	case AuthoritarianRegime: case StagnantThoughtsYearnForCatharsis: xx=55; break;
	case DragonsMaw: case UnLimitedPower: case StateOfTheSoulless: case RageInSolitude: xx=213; break;
}
